...
export default function PrivacyPage() {
  return (
    <main className="legal-page">
      ...
      <h2>Email for the service</h2><p>After the whole book is uploaded and the completed Page 1 translation options are visible, an email address is required so Bibaling can send the completed translation. Resend Contacts receives the normalized email, capture time, acquisition attribution, language pair, confirmed book form, and consent state. Resend Email receives the address and final translation for transactional delivery. It does not receive photos, filenames, prompts, model responses, or signed job receipts.</p>
