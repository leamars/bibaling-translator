...
export default function PrivacyPage() {
  return (
    <main className="legal-page">
      ...
      <h2>Email for the service</h2><p>After all three sample photos are uploaded and the completed Page 1 translation options are visible, an email address is required to generate Pages 2 and 3 and later continue into full-book translation. The server sends the normalized email, capture time, acquisition attribution, language pair, confirmed book form, and consent state to Resend Contacts. It does not send Resend book photos, filenames, text, translations, feedback, prompts, or model responses.</p>
